	...
	************************/
    ...
    while(counter<steps){
        ...
        while (fgets(line, sizeof(line), arx)) {
            ...
            if(iline == i1+i2+i3+1){
            sscanf(line,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf ",
                    &n12,&n22,&pc2,&tab_2[0],&tab_2[1],&tab_2[2],&tab_2[3],&tab_2[4],&tab_2[5],&tab_2[6],&tab_2[7],&tab_2[8],&tab_2[9],
            ...
            if(iline == i1+i2+i3+N){
            sscanf(line,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf ",
                    &n13,&n23,&pc3,&tab_3[0],&tab_3[1],&tab_3[2],&tab_3[3],&tab_3[4],&tab_3[5],&tab_3[6],&tab_3[7],&tab_3[8],&tab_3[9],
        ...
        while (fgets(line, sizeof(line), arx)) {
            ...
            if(iline == i1+i2+i3){
            sscanf(line,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf ",
                    &n15,&n25,&pc5,&tab_5[0],&tab_5[1],&tab_5[2],&tab_5[3],&tab_5[4],&tab_5[5],&tab_5[6],&tab_5[7],&tab_5[8],&tab_5[9],
            ...
            if(iline == i1+i2+i3+1){
            sscanf(line,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf ",
                    &n16,&n26,&pc6,&tab_6[0],&tab_6[1],&tab_6[2],&tab_6[3],&tab_6[4],&tab_6[5],&tab_6[6],&tab_6[7],&tab_6[8],&tab_6[9],
            ...
            if(iline == i1+i2+i3+N){
            sscanf(line,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf ",
                    &n17,&n27,&pc7,&tab_7[0],&tab_7[1],&tab_7[2],&tab_7[3],&tab_7[4],&tab_7[5],&tab_7[6],&tab_7[7],&tab_7[8],&tab_7[9],
            ...
            if(iline == i1+i2+i3+N+1){
            sscanf(line,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf ",
                    &n18,&n28,&pc8,&tab_8[0],&tab_8[1],&tab_8[2],&tab_8[3],&tab_8[4],&tab_8[5],&tab_8[6],&tab_8[7],&tab_8[8],&tab_8[9],
...
sscanf(argv[7],"%lf",&n2_min);
sscanf(argv[8],"%lf",&n2_max);
sscanf(argv[9],"%lf",&pc_min);
sscanf(argv[10],"%lf",&pc_max);
sscanf(argv[11],"%lf",&dv_min);
sscanf(argv[12],"%lf",&dv_max);
...
for(i = 0; i < Nbins; i++){
 sscanf(argv[13+i],"%f",&delta[i]);
 sscanf(argv[13+Nbins+i],"%f",&sigma[i]);
 sscanf(argv[13+2*Nbins+i],"%f",&error[i]);
}
